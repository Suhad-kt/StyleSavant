          ...
          <div>
            ...
            <div className="flex flex-col items-start">
              <input
                ...
                required
                className="block w-full mt-1  p-2 border  border-gray-300 rounded-md shadow-md focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
              />
            </div>
          </div>
          <div className="mt-4">
